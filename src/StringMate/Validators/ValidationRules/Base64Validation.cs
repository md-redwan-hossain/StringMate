...
namespace StringMate.Validators.ValidationRules
{
    ...
    {
        private static readonly Regex NotBase64Regex = new("[^A-Z0-9+\\/=]", RegexOptions.IgnoreCase);

        private static readonly Regex UrlSafeBase64Regex = new("^[A-Z0-9_\\-]*$", RegexOptions.IgnoreCase);
